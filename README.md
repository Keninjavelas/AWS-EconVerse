...
graph TD
    ...
    subgraph "Simulation Pipeline (Linear Execution)"
        SFN -->|Step 1| Anchor[λ Anchor Layer]
        SFN -->|Step 2| Macro[λ Macro Layer]
        SFN -->|Step 3| Market[λ Market Layer]
        SFN -->|Step 4| Agent[λ Agent Layer]
        SFN -->|Step 5| Ledger[λ Ledger Layer]
    end
    ...
    subgraph "Public Access Layer (Observer)"
        ...
        API -->|Invoke| Reader[λ Reader Layer]
